...
<template>
  <div
    ...
    class="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 mb-6 rounded-2xl border border-rose-500/20 bg-rose-500/10 text-white shadow-[0_0_15px_rgba(244,63,94,0.05)] animate-slide-in"
  >
    ...
    <button
      class="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-semibold text-xs tracking-wide transition-all uppercase duration-200 shadow-md shadow-rose-600/10 flex-shrink-0"
      @click="syncNetwork"
    >
      Sync dApp Network
    </button>
